...
<style>
   ...
   #saletbl,#refundtbl {margin-left:150px;}
   #tabs,#tabs1 {width:110px;margin:0; padding:0; list-style:none; overflow:hidden; }
    #tabs li,#tabs1 li {margin-bottom:5px; padding:5px; margin-right:0; background-color:white; width:100px; height:30px; cursor: pointer; text-transform: uppercase;transition: all 250ms ease;font: 600 13px/20px roboto, "Open Sans", Helvetica, sans-serif;text-align: center;
