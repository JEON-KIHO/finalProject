...
<style>
   ...
   #divCenter {width: 1500px; height: 1000px; margin-left: 200px; margin-top:50px;}
   .tabbed {width:60%; min-width:300px;margin: 0 auto;margin-top:100px;border-bottom: 4px solid #000;overflow: hidden;transition: border 250ms ease;}
     #tbl {color: #669;font-family:"Lucida Sans Unicode", "Lucida Grande", Sans-Serif;width:200px; overflow: hidden;transition: border 250ms ease;border-collapse: collapse;}
   .tabbed ul {margin:0px;padding: 0px;overflow: hidden;float:left;list-style-type: none; width:1000px; height:37px; margin-top:100px;}
   ...
   #saletbl th,#refundtbl th{font-size: 14px;font-weight: normal;color: #039;padding: 10px 8px;border-bottom: 2px solid #6678b1;}
   #saletbl td,#refundtbl td{width:180px;cursor: pointer; color: #669;padding: 10px 8px; font-size: 14px;font-weight: normal; border:0; border-bottom: 2px solid #6678b1;}
   table tbody tr:hover td{color: #009;}
   #saletbl,#refundtbl {margin-left:200px; margin-top:50px;}
   #tabs,#tabs1 {margin:0; padding:0; list-style:none; overflow:hidden; }
    #tabs li,#tabs1 li {display:block; padding:5px; background-color:white; width:150px; height:30px; margin :0px 0px 10px 0px;cursor: pointer; text-transform: uppercase;transition: all 250ms ease;font: 600 13px/20px roboto, "Open Sans", Helvetica, sans-serif;text-align: center;
    ...
    #tabs li.active, #tabs1 li.active {background-color:#6678b1;}
    #tabs li.active a, #tabs1 li.active a {color:#000; text-decoration:none;}
     #frmtbl4, #frmtbl5 {width:500px;}
    #modal, #modal1 {display:none;width: 500px;padding: 20px 60px;background-color: #fefefe;border: 1px solid #888;border-radius: 3px;}
   ...
   button {width: 50px; padding: .8em .5em; font-family: inherit; font-size:11px;-webkit-appearance: none;-moz-appearance: none;appearance: none;background:white; color: #669;border: 1px solid #ccc;border-radius: 5px;text-align:center;}
    ...
    #wrapper,#wrapper1{margin-left:430px; width:800px; height:200px;}
    ...
    #park {width:200px; height:640px;margin-top:50px; float:left; display:inline;}
    #tbl1 {float:left;  display:inline;}
    #park1 {float:left;}
    #deposittbl {color: #669; float:left;}
   </style>
...
<jsp:include page="menu.jsp"></jsp:include>
   ...
   <form name="salefrm" action="salesinsert" method="post">
      ...
      <div id="modal" style="float:left; margin-right:50px;">
