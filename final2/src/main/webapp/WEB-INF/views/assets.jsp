...
<body>
   ...
   <div id = "Loans">
      <table border = 1 style = "border-collapse:collapse; margin-top:300px;">
         <tr>
         ...
         <c:forEach items = "${Llist}" var = "vo">
            <tr>
               ...
               <td class="ltd"><a onclick = "window.open('loansassets?loansAccountCode=${vo.loansAccountCode}','대출계좌내역', 'width=700, height=600');">${vo.loansAccountCode}</a></td>               <td>${vo.loansAccount_startDay.substring(0,11)}</td>
