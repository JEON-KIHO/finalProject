...
public class SController {
   ...
   AdminService service;
    ...
    //카드,현금,기타별 총금액
      ...
      public List<HashMap<String, Object>> payTypeList(String date,HttpSession session){
         ...
         HashMap<String,Object> stMap=gMapper.salesTotalView(date, companyCode);
         HashMap<String,Object> rtMap=gMapper.refundTotalView(date, companyCode);
   ...
   public List<ArrayList<Object>> categoryListJson(String date,HttpSession session) {
      ...
      for(int i = 0; i < cList.size(); i++) {
         ...
         int rcnt = 0;
         arr=new ArrayList<>();
         String LC = (String) cList.get(i).get(".");
