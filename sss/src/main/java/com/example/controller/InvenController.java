...
public class InvenController {
   ...
   @ResponseBody
   public List<DayVO> invenDailyYearJson() {
   ...
   @ResponseBody
   public List<DayVO> invenDailyMonthJson(String date) {
   ...
   @ResponseBody
   public List<DayVO> invenDailyJson(String date) {
   ...
   public List<HashMap<String, Object>> invenListJson(String date) {
      String year = date.split("/")[0].substring(2);
      String month = date.split("/")[1];
   ...
   @ResponseBody
   public List<HashMap<String, Object>> endInvenListJson() {
